...
*  strsplit() This function split the elements of a character vector x into 
...
```{r} http://data.worldbank.org/data-catalog/GDP-ranking-table
```
...
```{r}
 ...
 setnames(GDP, c("X", "X.1", "X.3", "X.4"), 
    \label{keyc("CountryCode", "rankingGDP", "Long.Name", "gdp"))
