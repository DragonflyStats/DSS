...
The mean total number of steps taken per day is `r format(mean, scientific=FALSE)` steps.
...
The interval which contains the maximum number of steps on average across all the days is `r interval`th interval.
...
The total number of rows with missing values in the dataset is `r num_na`.
...
The mean total number of steps taken per day is `r format(mean_filled, scientific=FALSE)` steps and the median total number of steps taken per day is `r format(median_filled, scientific=FALSE)` steps, based on the dataset with filled NAs.
